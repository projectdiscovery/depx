...
// quarantineVerdictStyle renders QUARANTINED labels in light orange without bold.
func quarantineVerdictStyle(c aurora.Aurora, label string) string {
	return c.Index(214, label).String()
}
