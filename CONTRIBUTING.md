...
Point depx at a local inventory export (a gzipped JSON dump) for offline work or
against a self-hosted mirror:

```bash
export DEPX_SOURCE_URL=http://127.0.0.1:8080/export
