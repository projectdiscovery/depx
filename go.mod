...
// osv-scalibr pulls containerd v1.7.x (Limit int64) and buildkit v0.28.x (runtime-spec v1.3.0,
// Limit *int64). MVS picks v1.3.0 and Linux builds fail until scalibr/containerd v2 aligns.
